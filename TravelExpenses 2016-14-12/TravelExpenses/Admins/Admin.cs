...
namespace TravelExpenses
{
    public partial class Admin : Form
    {
        ...
        private void Admin_Load(object sender, EventArgs e)
        {
            ...
            pnCriteria.Size = new System.Drawing.Size(1155, 74);
            localCon.Open();
        ...
        private void cbtravels_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cbtravels.SelectedItem.ToString() == "Employee")
            {
                ...
                pnCriteria.Size = new System.Drawing.Size(1155, 127);
            ...
            else if (cbtravels.SelectedItem.ToString() == "Department")
            {
                ...
                tableLayoutPanel4.Visible = false;
                pnCriteria.Size = new System.Drawing.Size(1155, 185);
            }
            else if (cbtravels.SelectedItem.ToString() == "Employee + Date Range")
            {
                ...
                lblDepartments.Visible = false;
                cbDepartments.Visible = false;
                pnCriteria.Size = new System.Drawing.Size(1155, 246);
            }
            ...
            if (car)
            {
                ...
                while (drCR.Read())
                {
                    ...
                    else
                    {
                        ...
                        //fields.TryGetValue("Car District Pay" + carRow, out toSet);//commented for net6
                        //toSet.SetValue("No");//commented for net6
