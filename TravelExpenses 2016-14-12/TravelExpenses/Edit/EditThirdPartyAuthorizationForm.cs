    ...
    public partial class EditThirdPartyAuthorizationForm : Form
    {
        ...
        private void EditThirdPartyAuthorizationForm_Load(object sender, EventArgs e)
        {
           ...
           // dtpReturnDateValue.MinDate = dtpDepartureDateValue.Value;
            this.Size = new System.Drawing.Size(1138, 1093);
            loadingForm = false;
        }
        ...
        private void refreshAuthorizations()
        {
            ...
            if (cbEmployee.SelectedValue.ToString() != "-1")
            {
                ...
                query = "SELECT a.TravelEstimateID,a.UserID,[DepartureDate],[ReturnDate],[TravelEvent],[TravelPurpose],[BudgetedTravel],[EstimatedTravelCost],[Meals],[MealsCost],[MealsNotes],[Registration],[RegistrationCost],[RegistrationNotes],[Lodgings],[LodgingsCost],[LodgingsNotes],[CarRental],[CarRentalCost],[CarRentalNotes],[AirFare],[AirFareCost],[AirFareNotes],[Mileage],[MileageCost],[MileageNotes],[MileagePersonal],[OtherExpenses],[OtherExpensesCost],[OtherExpensesNotes],[Destination],b.Name,b.LastName FROM [TravelExpenses].[dbo].[EstimateTravel] as a inner join TravelExpenses.dbo.[User] as b on a.UserID = b.UserID where a.UserID = '" + userIDTR + "' order by a.DepartureDate desc";
            }
            else if (cbEmployee.SelectedValue.ToString() == "-1") 
            {
                query = "SELECT a.TravelEstimateID,a.UserID,[DepartureDate],[ReturnDate],[TravelEvent],[TravelPurpose],[BudgetedTravel],[EstimatedTravelCost],[Meals],[MealsCost],[MealsNotes],[Registration],[RegistrationCost],[RegistrationNotes],[Lodgings],[LodgingsCost],[LodgingsNotes],[CarRental],[CarRentalCost],[CarRentalNotes],[AirFare],[AirFareCost],[AirFareNotes],[Mileage],[MileageCost],[MileageNotes],[MileagePersonal],[OtherExpenses],[OtherExpensesCost],[OtherExpensesNotes],[Destination],b.Name,b.LastName FROM [TravelExpenses].[dbo].[EstimateTravel] as a inner join TravelExpenses.dbo.[User] as b on a.UserID = b.UserID  order by a.DepartureDate desc";
            }
            SqlCommand autho = new SqlCommand(query, localCon);
            SqlDataReader authoDR = autho.ExecuteReader();
            if (authoDR.HasRows)
            {
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            this.Size = new System.Drawing.Size(2233, 1093);
